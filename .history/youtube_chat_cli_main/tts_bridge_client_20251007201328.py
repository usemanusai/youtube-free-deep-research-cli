...
class TTSBridgeClient:
    ...
    def _run_bridge(self, args: list, timeout: int = 120) -> Dict[str, Any]:
        ...
        try:
            ...
            # Parse success response (be robust to banner lines before JSON)
            try:
    ...
    def generate_chatterbox(
        ...
        # Allow longer time for model load and inference on first calls
        response = self._run_bridge(args, timeout=600)
