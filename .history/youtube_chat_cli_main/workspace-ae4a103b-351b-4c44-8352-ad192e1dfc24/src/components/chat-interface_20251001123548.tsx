...
import { MessageSquare, Send, Loader2, Globe, RefreshCw, User, Bot, FileText, Paperclip } from 'lucide-react'
...
export function ChatInterface() {
  ...
  const handleFileUploaded = (fileInfo: any) => {
    ...
    toast.success(`File uploaded! You can now ask questions about it.`)

    // Add a system message about the uploaded file
    const systemMessage: Message = {
      id: Date.now().toString(),
      role: 'assistant',
      content: `✅ File "${fileInfo.file_name}" has been uploaded and added to the knowledge base. You can now ask questions about it!`,
      timestamp: new Date(),
    }
