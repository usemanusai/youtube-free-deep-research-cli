...
class WebScraperService:
            ...
            with sync_playwright() as p:
                for i in range(attempts):
                    try:
                        ...
                        browser = p.chromium.launch(headless=True, args=["--disable-blink-features=AutomationControlled"]) if stealth else p.chromium.launch(headless=True)
    ...
    def _inject_identity(self, context, page, cfg, url: str | None = None):
        # Cookies
        try:
