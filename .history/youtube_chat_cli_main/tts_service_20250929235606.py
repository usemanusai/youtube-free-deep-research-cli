...
class TTSService:
    ...
    def _generate_podcast_with_fallback(self, podcast_script: str, output_file: str) -> str:
        ...
        Creates a valid WAV file with 3 seconds of audible tone using Python's wave module,
        plus generates a summary text file. This ensures the podcast command always works
        and produces demonstrably playable audio files.
        ...
        try:
            # Create a valid WAV file with 3 seconds of 1kHz tone at 44.1kHz, 16-bit mono
            import wave
            import struct
            import math
            ...
            duration_sec = 3  # 3 seconds to make it noticeably playable
            frequency = 1000  # 1kHz tone
            num_samples = int(sample_rate * duration_sec)

            # Generate sine wave audio data (1kHz tone)
            audio_data = []
