...
def configure_logging() -> None:
    ...
    if log_format == "pretty":
        ...
        def _orjson_dumps(obj: Dict[str, Any], **kwargs):
            ...
            b = orjson.dumps(obj, default=default)
            # Ensure console-safe ASCII to avoid Windows cp1252 encoding errors
            return b.decode("utf-8").encode("ascii", "backslashreplace").decode("ascii")
